        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/4">
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="p-6 md:p-8 bg-[#916a6b] text-white text-center">
              ...
              <nav className="p-2 md:p-4 flex lg:flex-col overflow-x-auto lg:overflow-visible no-scrollbar space-x-2 lg:space-x-0 lg:space-y-1">
                ...
                <div className="hidden lg:block pt-6 mt-6 border-t border-gray-50">
                  <button 
                    onClick={logout}
                    className="w-full flex items-center space-x-4 px-5 py-4 rounded-2xl text-rose-500 hover:bg-rose-50 transition-all font-black uppercase tracking-widest text-xs"
                  >
                    <LogOut size={18} />
                    <span>Logout</span>
                  </button>
            ...
            <div className="lg:hidden mt-6">
              <button 
                onClick={logout}
                className="w-full flex items-center justify-center space-x-3 px-5 py-4 rounded-2xl bg-white border border-gray-100 shadow-sm text-rose-500 font-black uppercase tracking-widest text-[10px]"
              >
                <LogOut size={16} />
                ...
                <div className="space-y-8 animate-in fade-in duration-500">
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 md:mb-10">
                    ...
                    <button 
                        ...
                        className="w-full sm:w-auto px-6 py-2.5 border-2 border-[#916a6b] text-[#916a6b] rounded-xl text-[10px] md:text-xs font-black uppercase tracking-widest hover:bg-[#916a6b] hover:text-white transition-all active:scale-[0.98]"
                    >
                  ...
                  {isEditingProfile ? (
                    <form onSubmit={handleProfileUpdate} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="md:col-span-2 pt-8">
                            <button type="submit" className="bg-[#916a6b] text-white px-10 py-4 rounded-2xl font-black uppercase tracking-widest hover:shadow-xl hover:shadow-rose-900/20 transition-all active:scale-[0.98]">
                                Save Changes
                            </button>
                        </div>
                    </form>
                    ...
                    <>
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-12">
                        <div className="p-6 md:p-8 bg-[#FAF9F6] rounded-2xl md:rounded-3xl border border-gray-100 flex flex-col items-center text-center">
                          <ShoppingBag className="text-[#916a6b] mb-3 md:mb-4 w-6 h-6 md:w-8 md:h-8" size={32} />
                        ...
                        <div className="p-6 md:p-8 bg-[#FAF9F6] rounded-2xl md:rounded-3xl border border-gray-100 flex flex-col items-center text-center">
                          <Calendar className="text-[#916a6b] mb-3 md:mb-4 w-6 h-6 md:w-8 md:h-8" size={32} />
                        ...
                        <div className="p-6 md:p-8 bg-[#FAF9F6] rounded-2xl md:rounded-3xl border border-gray-100 flex flex-col items-center text-center sm:col-span-2 lg:col-span-1">
                          <ShieldCheck className="text-[#916a6b] mb-3 md:mb-4 w-6 h-6 md:w-8 md:h-8" size={32} />
                      ...
                      <div className="space-y-4 md:space-y-6 pt-4">
                        <div className="flex items-center justify-between p-4 md:p-6 bg-gray-50/50 rounded-2xl border border-gray-50 transition-colors">
                          <div className="flex items-center gap-4 md:gap-6">
                            <div className="w-10 h-10 md:w-14 md:h-14 bg-white rounded-xl md:rounded-2xl flex items-center justify-center shadow-sm border border-gray-100">
                              <User className="text-[#916a6b] w-5 h-5 md:w-6 md:h-6" size={24} />
                            </div>
                        ...
                        <div className="flex items-center justify-between p-4 md:p-6 bg-gray-50/50 rounded-2xl border border-gray-50 transition-colors">
                          <div className="flex items-center gap-4 md:gap-6 min-w-0">
                            <div className="w-10 h-10 md:w-14 md:h-14 bg-white rounded-xl md:rounded-2xl flex items-center justify-center shadow-sm border border-gray-100">
                              <Mail className="text-[#916a6b] w-5 h-5 md:w-6 md:h-6" size={24} />
                            </div>
                            <div className="min-w-0">
                ...
                <div className="space-y-8 animate-in fade-in duration-500">
                  ...
                  <form onSubmit={handlePasswordUpdate} className="w-full max-w-md space-y-4">
                    ...
                    <div className="space-y-1">
                     ...
                     <div className="pt-8">
                        <button type="submit" className="bg-[#916a6b] text-white px-10 py-4 rounded-2xl font-black uppercase tracking-widest hover:shadow-xl hover:shadow-rose-900/20 transition-all active:scale-[0.98] w-full sm:w-auto">
                            Update Password
                        </button>
                    </div>
                  </form>
              ...
              {activeTab === "notifications" && (
                 <div className="flex flex-col items-center justify-center py-24 text-center animate-in fade-in duration-500">
                    <div className="w-20 h-20 bg-[#FAF9F6] rounded-3xl flex items-center justify-center mb-6 shadow-sm border border-gray-100">
                        <Bell className="text-[#916a6b]" size={32} />
                    </div>
