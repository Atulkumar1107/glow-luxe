    ...
    return (
        <div className="min-h-screen bg-[#FAF9F6] py-12 mt-12 px-4">
            ...
            <div className="max-w-md mx-auto">
                ...
                <div className="bg-white p-10 rounded-[2rem] shadow-2xl shadow-rose-900/5 border border-gray-100">
                    <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`mt-1 block w-full px-4 py-3 text-black rounded-xl border bg-gray-50 ${validationErrors.firstName
                                        ...
                                        : "border-gray-100 focus:ring-2 focus:ring-[#916a6b] focus:border-[#916a6b]"
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className={`w-full bg-[#916a6b] text-white py-4 px-6 rounded-xl shadow-xl shadow-rose-900/10 hover:bg-[#7a595a] transition-all font-black uppercase tracking-widest active:scale-[0.98] ${isLoading ? "opacity-75 cursor-not-allowed" : ""
                                }`}
                        >
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-gray-600">
                            ...
                            <Link href="/login" className="text-[#916a6b] font-bold hover:text-[#7a595a] transition-colors">
                                Sign in
                            </Link>
                        </p>
                    </div>
